    ...
    >
      ...
      >
        ...
        >
         ...
         <Text style={{paddingTop:12,paddingHorizontal:10,fontSize:18,fontWeight:400,color:"#777"}}>Discover curated collections of stunning wallpapers. Browse by category, preview. in full-screen , and set your favorite</Text>
    </View> 

      {/* Search Bar */}
      <View style={styles.category}>
         <Text style={{fontWeight:"600",fontSize:22}}>Category</Text>
         <Text style={{fontWeight:"600",fontSize:18,color:"gray"}}>See all</Text>
      </View>
